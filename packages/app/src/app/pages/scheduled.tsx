...
const AutomationCard = (props: {
  ...
  return (
    ...
    >
      <div class={`mb-4 flex h-8 w-8 items-center justify-center rounded-lg glass-panel ${
        props.tone ?? ""
      }`}>
        <Icon size={18} />
      </div>
...
const AutomationJobCard = (props: {
  ...
  return (
    <div class="flex flex-col gap-4 rounded-2xl glass-panel p-5 shadow-sm">
  ...
  return (
    <section class="space-y-10">
      ...
      <div class="pt-8 text-center">
        <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl glass-panel shadow-sm">
        ...
        <div class="rounded-2xl border border-gray-5 bg-gradient-to-b from-gray-1 to-gray-2/70 px-5 py-5 shadow-sm">
          <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex items-start gap-3">
              <div class="flex h-10 w-10 items-center justify-center rounded-xl glass-panel">

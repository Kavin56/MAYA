    ...
    <section class="space-y-6">
      <div class="card-glass p-5 space-y-4">
                ...
                return (
                  <div class="rounded-2xl glass-panel/40 p-4 space-y-3">
                    ...
                    <Show when={isGuided() && isGuideOpen()}>
                      <div class="rounded-xl glass-panel/60 p-4 space-y-3">
        ...
        <Show
          ...
          fallback={
            <div class="rounded-xl glass-panel/40 p-4 text-sm text-gray-10">
        ...
        >
          <div class="grid gap-2">
            <For each={props.pluginList}>
              {(pluginName) => (
                <div class="flex items-center justify-between rounded-xl glass-panel/40 px-4 py-2.5">

...
function StatusPill(props: { label: string; value: string; ok: boolean }) {
  return (
    <div class="flex-1 rounded-lg glass-panel px-3.5 py-2.5">
  ...
  return (
    <div class="space-y-6 max-w-[680px]">
      ...
      <Show when={!serverReady()}>
        <div class="rounded-xl glass-panel p-5">
      ...
      <Show when={serverReady()}>
        ...
        <div class="flex items-center gap-2 rounded-xl glass-panel p-1">
          <button
        ...
        {/* ---- Worker status card ---- */}
        <div class="rounded-xl glass-panel p-4 space-y-3.5">
                ...
                <div class="border-t border-gray-4 px-4 py-4 space-y-3 animate-[fadeUp_0.2s_ease-out]">
                  ...
                  <Show when={telegramIdentities().length > 0}>
                    <div class="space-y-2">
                      <For each={telegramIdentities()}>
                        {(item) => (
                          <div class="flex items-center justify-between gap-3 rounded-lg glass-panel px-3 py-2.5">
                            <div class="min-w-0">
                              <div class="flex items-center gap-2">
                  ...
                  <div class="space-y-2.5">
                    ...
                    <div>
                      ...
                      <input
                        class="w-full rounded-lg glass-panel px-3 py-2.5 text-sm text-gray-12 placeholder:text-gray-8"
        ...
        <div class="rounded-xl glass-panel p-4 space-y-3">
          ...
          <textarea
            class="min-h-[220px] w-full rounded-lg glass-panel px-3 py-2.5 text-[13px] font-mono text-gray-12 placeholder:text-gray-8"
        ...
        <div class="rounded-xl glass-panel p-4 space-y-3">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div>
              ...
              <select
                class="w-full rounded-lg glass-panel px-3 py-2 text-sm text-gray-12"
                value={sendChannel()}
            ...
            <div>
              ...
              <input
                class="w-full rounded-lg glass-panel px-3 py-2 text-sm text-gray-12 placeholder:text-gray-8"
          ...
          <div>
            ...
            <textarea
              class="min-h-[90px] w-full rounded-lg glass-panel px-3 py-2 text-sm text-gray-12 placeholder:text-gray-8"

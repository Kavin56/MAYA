      ...
      <Match when={props.onboardingStep === "local"}>
        <div class="min-h-screen flex flex-col items-center justify-center bg-gray-1 text-gray-12 p-6 relative">
          ...
          <div class="max-w-lg w-full z-10 space-y-6">
            ...
            <div class="space-y-4">
              <div class="card-glass p-5 flex flex-wrap items-center justify-between gap-3">
                <div>
              ...
              <div class="rounded-2xl glass-panel/50 px-4 py-3">
            ...
            <details class="rounded-2xl glass-panel/60 px-4 py-3">
              ...
              <div class="pt-3 space-y-3">
                ...
                <div class="flex items-center justify-between gap-3 rounded-xl glass-panel/40 px-3 py-2">

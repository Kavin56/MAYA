            ...
            <div class="max-w-xl w-full z-10 space-y-10">
              <div class="text-center space-y-4">
                <div class="flex flex-col items-center justify-center gap-4 mb-6">
                  ...
                  <h2 class="text-4xl font-extrabold tracking-tight text-gray-12">MAYA</h2>
                </div>
              ...
              <div class="rounded-2xl glass-panel/60 px-5 py-4">
            ...
            <aside class="w-60 border-r border-gray-6 p-6 hidden md:flex flex-col justify-between bg-gray-1">
              <div>
                <div class="flex items-center justify-center gap-3 mb-10 px-2">
                  ...
                  <span class="font-extrabold text-2xl tracking-tight">MAYA</span>
                </div>
                <nav class="space-y-1">
                  <For each={navItems}>
                    {(item) => (
              ...
              <div class="p-6 md:p-8 max-w-4xl mx-auto space-y-8">
                ...
                <section class="space-y-4">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <For each={workspaces}>
                      {(workspace) => (
                        <div class="rounded-2xl glass-panel/40 p-4 space-y-3">
            ...
            <div class="flex-1 flex overflow-hidden">
              <aside class="hidden lg:flex w-72 border-r border-gray-6 bg-gray-1 flex-col">
                ...
                <div class="p-4 space-y-2">
                  <For each={sessions}>
                    {(session) => (
                      <button class="w-full text-left rounded-xl glass-panel/40 px-3 py-2">
              ...
              <div class="flex-1 overflow-y-auto pt-6 md:pt-10 px-6 md:px-10">
                <div class="max-w-2xl mx-auto space-y-6">
                  ...
                  <div class="space-y-4">
                    <div class="rounded-2xl glass-panel/40 p-4">
              ...
              <aside class="hidden lg:flex w-72 border-l border-gray-6 bg-gray-1 flex-col">
                ...
                <div class="p-4 space-y-3 text-sm text-gray-10">
                  <div class="rounded-xl glass-panel/40 p-3">
                    Working files: 4
                  </div>
                  <div class="rounded-xl glass-panel/40 p-3">
                    Skills: 2

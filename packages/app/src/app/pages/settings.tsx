...
export default function SettingsView(props: SettingsViewProps) {
  ...
  return (
    <section class="space-y-6">
      <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between rounded-2xl glass-panel/40 px-3 py-2">
        ...
        <Match when={activeTab() === "model"}>
          <div class="space-y-6">
            <div class="card-glass p-5 space-y-4">
              ...
              <div class="flex items-center justify-between glass-panel p-3 rounded-xl gap-3">
                <div class="min-w-0">
                  ...
                  <Show
                    ...
                    fallback={
                      <>
                        ...
                        <div class="flex items-center justify-between gap-3 glass-panel p-3 rounded-xl">
                          <div class="space-y-0.5">
        ...
        <Match when={activeTab() === "debug"}>
          <Show when={props.developerMode}>
            <section>
              ...
              <div class="space-y-4">
                <div class="card-glass p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div class="min-w-0">
                  ...
                  <div class="card-glass p-5 space-y-4">
                    ...
                    <Show when={props.developerMode && props.engineSource === "custom"}>
                      <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                          <div
                            class="flex-1 min-w-0 text-[11px] text-gray-7 font-mono truncate glass-panel p-3 rounded-xl"
                    ...
                    <div class="glass-panel p-4 rounded-xl space-y-3">
                      ...
                      <div class="grid gap-2">
                        <div>
                          ...
                          <pre class="text-xs text-gray-12 whitespace-pre-wrap break-words max-h-24 overflow-auto bg-gray-2/50 dark:bg-black border border-gray-6 rounded-lg p-2">
                            {engineStdout()}
                          </pre>
                        </div>
                        <div>

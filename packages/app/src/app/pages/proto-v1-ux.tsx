...
const AutomationCard = (props: {
  ...
  return (
    <button
      type="button"
      onClick={props.onClick}
      class="group flex h-full min-h-[120px] w-full min-w-[240px] flex-1 flex-col rounded-2xl glass-panel/80 p-5 text-left transition-shadow hover:shadow-md"
    >
      <div
        class={`mb-4 flex h-9 w-9 items-center justify-center rounded-xl glass-panel ${
...
const SkillCard = (props: {
  ...
  const Icon = props.icon;
  return (
    <div class="flex items-start justify-between rounded-2xl glass-panel/70 p-4 transition-colors hover:border-gray-7">
      <div class="flex gap-4">
        <div class="flex h-10 w-10 items-center justify-center rounded-xl glass-panel shadow-sm">
  ...
  <Show when={props.open}>
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-12/30 px-4 backdrop-blur-sm">
      <div
        ...
        class="w-full max-w-2xl rounded-3xl glass-panel shadow-xl"
      >
        <div class="p-8">
    ...
    <main class="min-h-screen bg-gray-1 text-gray-12">
      <div class="relative min-h-screen">
        ...
        <div class="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-6 px-4 py-6 lg:flex-row lg:gap-4 lg:px-6">
          <aside class="flex w-full flex-col gap-6 rounded-3xl glass-panel/80 p-4 lg:w-72">
          ...
          <section class="flex min-h-[70vh] flex-1 flex-col overflow-hidden rounded-3xl glass-panel/90 shadow-sm">
            <Switch>
              ...
              <Match when={true}>
                ...
                <div class="relative flex flex-1 flex-col items-center justify-center px-6 pb-24">
                  ...
                  <div class="absolute bottom-6 w-full max-w-3xl">
                    <div class="rounded-2xl glass-panel px-3 py-2 shadow-lg">
                      <textarea
                        rows={1}
                      ...
                      <div class="flex items-center justify-between px-2 pb-2">
                        <div class="flex items-center gap-2">
                          ...
                          <div class="h-4 w-px bg-gray-6 mx-1"></div>
                          <button
                            type="button"
                            onClick={() => {
                              // Trigger OWL Multi-Agent feature
                              console.log("OWL Workforce engaged!");
                              alert("🦉 OWL Multi-Agent Workforce Engaged!\nAgents are now actively researching and analyzing your request.");
                            }}
                            class="flex items-center gap-2 rounded-md px-2 py-1 text-xs font-bold text-amber-500 bg-amber-500/10 transition-colors hover:bg-amber-500/20"
                            title="Engage OWL Multi-Agent Workforce"
                          >
